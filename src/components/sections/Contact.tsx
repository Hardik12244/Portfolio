...
export default function Contact() {
  return (
    <section
      id="contact"
      className="py-24 px-4 max-w-4xl mx-auto mb-10"
    >
      <motion.div
      ...
      >
        ...
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-green-500/10 text-green-600 text-xs font-semibold mb-8">
          ...
          <p className="text-[var(--muted)] text-lg mb-10 max-w-xl mx-auto leading-relaxed">
            Whether it&apos;s a startup idea, a scalable backend
            system, or an AI-integrated application, I&apos;m
            always open to discussing new projects.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="mailto:hardikgargwork@gmail.com"
              className="
      ...
      <div className="mt-16 flex flex-col md:flex-row items-center justify-between pt-8 border-t border-[var(--border)] text-sm text-[var(--muted)]">
        <p>
          © {new Date().getFullYear()} Hardik Garg. All rights
          reserved.
        </p>
